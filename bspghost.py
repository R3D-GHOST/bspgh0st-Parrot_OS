...
|  _ \___ \| |_) | |  _| |_| | | | \___ \ | |  
| |_) |__) |  __/| |_| |  _  | |_| |___) || |  
|____/____/|_|    \____|_| |_|\___/|____/ |_|  
...
def poly():
    ...
    os.system("cd ; git clone --depth=1 https://github.com/adi1090x/polybar-themes.git ; cd polybar-themes ; chmod +x setup.sh ; ./setup.sh ")
